...
@section('content')
    <div class=" d-flex flex-column flex-shrink-1 container py-4 h-100 bg-white">
        ...
        {!! Form::open([
            'method' => 'PATCH',
            'route' => ['equipment.update', $equipment->id],
        ...
        <div class="row">
            <div class="col-4">
                <div class="container d-flex flex-md-column align-items-center">
                    ...
                    <img src="{{ url($equipment->image->path) }}" alt="{{ $equipment->image->alt }}" id="mainImagePreview"
            ...
            <div class="col">
                ...
                <div class="row pt-2">
                    <div class="col">
                        ...
                        {!! Form::select('numbers_sets', ['2' => '2', '4' => '4'], $equipment->number_sets, [
                            'class' => 'form-select',
                            'id' => 'rarity',
                        ]) !!}
                        @error('numbers_sets')
                ...
                <div class="row pt-2">
                    <div class="col">
                        ...
                        {!! Form::textarea('description', $equipment->description, [
                            'class' => 'form-control',
